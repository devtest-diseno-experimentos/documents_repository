...
|--------------------|--------------------|-------------|
| **Reconoce responsabilidad ética y profesional en situaciones de ingeniería de software** |                                                                                                          **Italo D'Alessandro Luna Capuñay**                                                            <br>**TB1:**<br>      En esta entrega, detecté diversos riesgos éticos y de privacidad en el proyecto de software, especialmente aquellos vinculados a la protección de datos personales. Colaboré con el equipo para definir medidas de seguridad que garantizaran la protección de la información de los usuarios. Esta experiencia fortaleció mis habilidades en la identificación y gestión de riesgos éticos dentro de proyectos de software. <br>**TP:**<br>       He aplicado responsabilidad ética al desarrollar y ejecutar pruebas unitarias que garantizan la calidad del código, asegurando que cada módulo funcione correctamente antes de la integración. Esto contribuye a un software confiable y seguro para los usuarios.<br>**TB2:**<br>       Durante esta entrega, desarrollé un plan de seguimiento de datos para plataformas web y móviles, considerando la accesibilidad, seguridad y privacidad de los usuarios. Aseguré que las soluciones tecnológicas fueran inclusivas y no tuvieran efectos adversos en la seguridad de los usuarios. Esta experiencia me permitió entender la importancia de la responsabilidad ética en cada fase del desarrollo del software, destacando la necesidad de ser consciente de los riesgos asociados con el manejo de datos.<br>**TF1:**<br> Durante esta fase, trabajé en la definición de las To-Be User Stories, los Sprint Backlogs y la implementación de la aplicación móvil. Me aseguré de que las historias de usuario reflejaran necesidades reales sin comprometer la privacidad ni la experiencia del usuario. Además, en el desarrollo móvil, consideré buenas prácticas de accesibilidad y usabilidad. Esta experiencia reafirmó mi compromiso con una ingeniería de software ética y centrada en el usuario.      <br><br>                                                                                                                **Rodrigo Alejandro Castillo Aguilar** <br>**TB1:**<br>     Durante esta entrega, me encargué de revisar si el diseño del software contemplaba la accesibilidad y la inclusión de todos los usuarios, proponiendo mejoras para asegurar que la aplicación sea apta para personas con discapacidades. Esta tarea me ayudó a fortalecer mis habilidades en la gestión de riesgos éticos en proyectos de software y a fomentar la inclusión y diversidad en el proceso de desarrollo. <br>**TP:**<br> Me he comprometido con la responsabilidad profesional implementando pruebas automatizadas con Selenium, buscando detectar errores tempranamente y prevenir fallos en la interfaz de usuario, manteniendo altos estándares de calidad y ética en el desarrollo.<br>**TB2:**<br>       En esta entrega, seleccioné las condiciones y métodos experimentales para el análisis de datos, tomando en cuenta su impacto ético. Me aseguré de que los datos fueran tratados con transparencia y equidad, evitando sesgos que pudieran afectar los resultados. Esta tarea me permitió reflexionar sobre cómo cada decisión técnica que tomo tiene repercusiones éticas, y la importancia de ser responsable al trabajar con datos sensibles y métricas clave. <br>**TF1:**<br> Durante esta fase, me encargué de elaborar el To-Be Product Backlog y de la implementación de la landing page. Me aseguré de que las funcionalidades priorizadas en el backlog respondieran a necesidades reales del usuario, manteniendo un enfoque claro en la accesibilidad y experiencia de uso. En la implementación, cuidé cada detalle visual y funcional para que la página representara de forma profesional e inclusiva al producto. Esta experiencia reforzó mi responsabilidad ética en la toma de decisiones técnicas con impacto directo en los usuarios. <br><br>                                                                                                           **Mathias Tsuneo Kunimoto Watanabe** <br>**TB1:**<br>   Durante esta entrega, me encargué de evaluar si el diseño del software contemplaba adecuadamente la accesibilidad y la inclusión de todos los usuarios, proponiendo mejoras para asegurar que la aplicación fuera apta para personas con discapacidades. Además, me responsabilicé de desarrollar una vista en la aplicación móvil, cuidando que su diseño fuera tanto visualmente atractivo como accesible, considerando aspectos como la legibilidad, el contraste y la facilidad de navegación. Esta experiencia me permitió fortalecer mis habilidades en la gestión de riesgos éticos en proyectos de software, así como fomentar la inclusión, la diversidad y el diseño inclusivo dentro del proceso de desarrollo.  <br>**TP:**<br>  He trabajado con responsabilidad ética en la realización de pruebas integrales, verificando que todos los componentes interactúen correctamente y que el sistema cumpla con los requisitos funcionales, protegiendo la experiencia final del usuario. <br>**TB2:**<br>       Durante esta entrega, me enfoqué en implementar herramientas de monitoreo y alertas para asegurar que los componentes del pipeline de software funcionaran correctamente. Además, me aseguré de que el sistema fuera transparente y seguro para los usuarios, evaluando posibles riesgos y garantizando la protección de los datos. Esta experiencia me permitió reflexionar sobre la responsabilidad ética que tengo como ingeniero de software, asegurando que las soluciones no solo sean efectivas, sino también responsables en cuanto a privacidad y seguridad.<br>**TF1:**<br>  Durante esta entrega, trabajé en el diseño de entrevistas, la re-priorización del backlog de preguntas y la planificación del ciclo de vida de la plataforma basada en experimentación. Me aseguré de que las entrevistas respetaran la ética en la recopilación de datos y que las decisiones técnicas se alinearan con los aprendizajes obtenidos. Esta experiencia me ayudó a valorar la responsabilidad profesional en la toma de decisiones durante todo el ciclo de desarrollo. <br>                                                                                                 <br><br>                                                                                                           **Jean Franco Joel Barrionuevo Reto** <br>**TB1:**<br> Durante esta entrega, estuve a cargo de terminar la aplicacion mobile y brindar los assets necesarios para el proyecto, esto me ayudo a fortalecer mi responsabilidad y entragar todas las cosas a tiempo, junto a una buena coordinacion y orden en nuestro proyecto junto con mi equipo. <br>**TP:**<br>   He asumido una postura profesional y ética durante el proceso de despliegue, asegurando que la entrega del software sea segura, eficiente y conforme a las mejores prácticas, minimizando riesgos y garantizando la continuidad del servicio.<br>**TB2:**<br>       Durante esta entrega, desarrollé hipótesis para evaluar la efectividad del software, tomando en cuenta las implicaciones éticas en la recolección de datos y en la privacidad de los usuarios. Reflexioné sobre la importancia de proteger la información sensible y aseguré que el software respetara los derechos de los usuarios. Esta experiencia me permitió profundizar en la responsabilidad ética de las decisiones que tomo como ingeniero de software, buscando siempre un equilibrio entre la innovación y la protección de los usuarios. <br>**TF1:**<br> Durante esta fase, me enfoqué en el análisis posterior a los experimentos, la documentación del aprendizaje y la preparación del pre-lanzamiento de la plataforma. Reflexioné sobre los resultados obtenidos y compartí aprendizajes clave con el equipo, asegurando siempre un enfoque ético y profesional. Esta experiencia me ayudó a entender la importancia de evaluar el impacto de nuestras decisiones en el producto final.                                                                                        <br><br>                                                                                                           **Augusto Jose Pin Matallana** <br>**TB1:**<br> Durante esta entrega, me encargue de avanzar tanto la aplicacion mobile como añadir puntos en el documento y dejar todo  listo para que mis compañeros avanzaran, Esta tarea me ayudo a comprender la importancia de un orden y limpienza en nuestra documentacion. <br>**TP:**<br>  He demostrado responsabilidad ética en la coordinación y revisión de todas las pruebas, asegurando que el producto final sea confiable y cumpla con los estándares de calidad, reflejando un compromiso con la excelencia y la integridad profesional. <br>**TB2:**<br>       En esta entrega, trabajé en la identificación de suposiciones y brechas de conocimiento, asegurándome de que el software que propongo esté alineado con principios éticos. Consideré las implicaciones sociales y profesionales de mis decisiones, asegurando que las soluciones fueran accesibles y respetaran los derechos de todos los usuarios. Esta actividad me ayudó a comprender mejor cómo la ingeniería de software no solo depende de la eficiencia técnica, sino también de las implicaciones éticas y sociales de las decisiones tomadas. <br>**TF1:**<br>       Durante esta entrega, participé en el análisis de resultados, la priorización del backlog de preguntas y la implementación del frontend web. Me aseguré de que las decisiones tomadas a partir de los datos fueran éticas y basadas en evidencia, y que la aplicación web ofreciera una experiencia accesible y funcional. Esta etapa reforzó mi compromiso con un desarrollo responsable y centrado en el usuario.                                                                               <br><br>                                                                                          |                                                                                                        Durante esta entrega, cada integrante del equipo se enfocó en reconocer y abordar riesgos éticos relacionados con la privacidad y la seguridad de los datos de los usuarios. Se implementaron medidas de protección para garantizar la seguridad de la información. Asimismo, se impulsó la diversidad y la accesibilidad en el desarrollo del software, asegurando la inclusión de todos los usuarios.                                                                                                     
| **Emite juicios informados considerando el impacto de las soluciones de ingeniería de software en contextos globales, económicos, ambientales y sociales**|                                                                                            **Italo D'Alessandro Luna Capuñay**                                                            <br>**TB1:**<br>                                   En esta entrega, analicé el impacto que el software podría tener en usuarios de diversas culturas y regiones, considerando su capacidad de adaptación y su proyección a nivel global durante el desarrollo.<br>**TP:**<br>  He desarrollado juicios informados al evaluar cómo las soluciones de ingeniería de software impactan en distintos contextos globales y económicos, considerando la eficiencia y sostenibilidad de las pruebas unitarias para ofrecer un producto responsable y adaptable. <br>**TB2:**<br>  En esta entrega, al desarrollar el plan de seguimiento de datos, reflexioné sobre el impacto de las soluciones tecnológicas en la accesibilidad global y en la sostenibilidad ambiental. Evalué cómo las decisiones de desarrollo podrían afectar la eficiencia de los recursos y cómo mejorar la experiencia del usuario en diferentes contextos sociales y económicos. Este enfoque me permitió tomar decisiones más informadas que consideran no solo el rendimiento técnico, sino también las repercusiones sociales y ambientales a largo plazo.<br>**TF1:**<br> En esta entrega, reflexioné sobre cómo las decisiones en el desarrollo de software pueden afectar a diferentes usuarios según su contexto social, económico y tecnológico. Procuré que las soluciones fueran accesibles, eficientes y sostenibles, con el fin de generar un impacto positivo y equitativo. Esto me permitió tomar decisiones informadas que van más allá del aspecto técnico.                                                                <br><br>                                                                                                    **Rodrigo Alejandro Castillo Aguilar** <br>**TB1:**<br>                                                                        Durante esta entrega, analicé el efecto social del software en la movilidad urbana y propuse iniciativas para mejorar la calidad de vida de los usuarios. También verifiqué que el desarrollo del software respetara los estándares éticos y profesionales, teniendo en cuenta su influencia en la sociedad.  <br>**TP:**<br> He tomado decisiones conscientes sobre el uso de pruebas automatizadas con Selenium, valorando su influencia en la reducción de recursos y tiempo, y su repercusión en la productividad y el entorno económico del proyecto. <br>**TB2:**<br>  Durante esta entrega, tomé decisiones informadas sobre los métodos y condiciones experimentales, considerando cómo estas soluciones podrían tener un impacto económico y social. Evalué los efectos que las decisiones tomadas podrían tener en el uso de recursos y en la accesibilidad de las soluciones tecnológicas. Este proceso me permitió considerar el impacto a largo plazo de mis decisiones y cómo estas pueden contribuir a una mayor equidad social y económica. <br>**TF1:**<br> En esta entrega, reflexioné sobre cómo las decisiones de ingeniería de software pueden impactar a distintos tipos de usuarios en contextos sociales y económicos diversos. Busqué que las soluciones fueran accesibles, eficientes y sostenibles, considerando tanto la experiencia del usuario como el uso responsable de recursos. Esto me permitió tomar decisiones más conscientes y equilibradas, pensando en un impacto positivo a largo plazo.                        <br><br>                                                                                                           **Mathias Tsuneo Kunimoto Watanabe** <br>**TB1:**<br>                                                                                 Durante esta entrega, evalué el impacto social del software en la movilidad urbana y propuse acciones destinadas a mejorar la calidad de vida de los usuarios. Asimismo, me aseguré de que el desarrollo del software cumpliera con los estándares éticos y profesionales, considerando su efecto en la sociedad. <br>**TP:**<br>He analizado de manera crítica el efecto de las pruebas integrales en la calidad del software, reconociendo su papel para minimizar riesgos sociales y ambientales, garantizando que las soluciones contribuyan positivamente a la comunidad y al medio ambiente. <br>**TB2:**<br>  En esta entrega, evalué el impacto global de las herramientas de monitoreo y alerta que implementé, considerando cómo estas soluciones pueden mejorar la eficiencia del sistema a nivel económico. También reflexioné sobre su impacto en la sostenibilidad y en la eficiencia operativa a largo plazo. Este proceso me permitió tomar decisiones más informadas que no solo optimizan el rendimiento del software, sino que también contribuyen al bienestar de las comunidades y la sostenibilidad de los recursos. <br>**TF1:**<br> En esta entrega, reflexioné sobre el impacto que pueden tener las decisiones en la planificación y validación de un producto de software. Consideré cómo nuestras soluciones podrían adaptarse a distintos contextos sociales y económicos, buscando siempre fomentar la inclusión y minimizar riesgos. Esto me permitió tomar decisiones más informadas, pensando en el valor real que puede aportar el producto en entornos diversos.                     <br><br>                                                                                                           **Jean Franco Joel Barrionuevo Reto** <br>**TB1:**<br> Durante esta entrega, analice lo mas necesario para nuestros usuarios y cual seria un buena implementación añadida para nuestros servicios. Asimismo, me encargue de analizar que plataforma seria util para unos segmentos objetivos amplios y con necesidades donde el sofware aun no abarcaba.<br>**TP:**<br>  He considerado el impacto ambiental y social al planificar y ejecutar el despliegue del sistema, buscando optimizar procesos y recursos para disminuir la huella ambiental y mejorar la accesibilidad y utilidad del software en contextos diversos. <br>**TB2:**<br>  En esta entrega, evalué las implicaciones sociales, económicas y ambientales de las soluciones tecnológicas que propuse, analizando cómo las decisiones tomadas afectarán a largo plazo tanto a los usuarios como al medio ambiente. Aseguré que las soluciones fueran sostenibles y que contribuyeran a una mejora en la calidad de vida de las personas, tanto a nivel local como global. Este enfoque me permitió tomar decisiones más informadas que no solo resuelven problemas técnicos, sino que también consideran el bienestar de la sociedad y del planeta. <br>**TF1:**<br>  En esta entrega, reflexioné sobre cómo las decisiones tomadas durante el desarrollo afectan el valor final del producto en distintos contextos. Consideré la importancia de compartir aprendizajes, validar resultados y preparar el lanzamiento con responsabilidad, evaluando el impacto potencial en usuarios de diversas realidades sociales y económicas. Esto me permitió emitir juicios más informados y conscientes del alcance real de nuestras soluciones.                                                         <br><br>                                                                                                           **Augusto Jose Pin Matallana** <br>**TB1:**<br> Durante esta entrega, evalue la importancia del software dentro del topico de la compra y venta de autos. Tambien me asegure de que haya un espacio para una aplicacion como la nuestra, que sirva en la vida util de los consumidores y lograr un cambio para la problematica. <br>**TP:**<br> He emitido juicios fundamentados en la revisión y coordinación de pruebas, entendiendo cómo las decisiones técnicas pueden influir en el bienestar social, la economía y la sostenibilidad global, promoviendo soluciones integrales y responsables.<br>**TB2:**<br>  Durante esta entrega, evalué cómo las suposiciones y brechas de conocimiento que identifiqué podrían influir en la implementación de soluciones tecnológicas a nivel económico y social. Me aseguré de que las decisiones tomadas tuvieran en cuenta su impacto en la accesibilidad y en los diferentes grupos de usuarios, buscando soluciones que fueran inclusivas y que tuvieran un efecto positivo en la sociedad. Esta reflexión me permitió comprender la importancia de emitir juicios informados que consideren el impacto global de las soluciones propuestas. <br>**TF1:**<br> En esta entrega, reflexioné sobre cómo las decisiones técnicas y de priorización pueden influir en la experiencia de usuarios con diferentes realidades. Consideré el impacto que nuestras soluciones pueden tener en la accesibilidad, eficiencia y utilidad del producto en diversos entornos. Esta perspectiva me permitió tomar decisiones más informadas y conscientes del efecto social y global de nuestro desarrollo.                                                                                                                        |                                                                                                           Durante esta entrega, el equipo se dedicó a analizar el impacto social, económico y ambiental que el software podría generar en la movilidad urbana. Se fomentó un ambiente de colaboración e inclusión, promoviendo la participación activa de todos los integrantes. También se definieron objetivos claros y se organizaron las tareas para alcanzar las metas propuestas. Además, se presentaron recomendaciones fundamentadas que buscan equilibrar la viabilidad técnica del proyecto con su compromiso social, económico y ambiental.                                                                                                       | 
...
<img src="../assets/interview-photos/entrevista-2-segmento-2.png">
...
<img src="../assets/interview-photos/entrevista-1-segmento-3.png">
...
<img src="../assets/interview-photos/entrevista-2-segmento-3.png">
...
![image](../assets/impact-mapping/impact-map1.png)
...
![image](../assets/impact-mapping/impact-map2.png)
...
![image](../assets/impact-mapping/impact-map3.png)
...
* Exposicion TF1: [Link](https://upcedupe-my.sharepoint.com/:v:/g/personal/u202210148_upc_edu_pe/EcaWls8IOAxIp1toxiwsWG8B0LF658O9c8qpOB_kbY3a4Q?e=I7rRQU&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D)
